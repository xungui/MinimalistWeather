...
class LifeIndexAdapter(private val context: Context, private val indexList: List<LifeIndex>?) : BaseRecyclerViewAdapter<LifeIndexAdapter.ViewHolder>() {
    ...
    private fun getIndexDrawable(context: Context, indexName: String): Drawable {
        ...
        when {
            indexName.contains("防晒") -> colorResourceId = R.drawable.ic_index_sunscreen
            indexName.contains("穿衣") -> colorResourceId = R.drawable.ic_index_dress
            indexName.contains("运动") -> colorResourceId = R.drawable.ic_index_sport
            indexName.contains("逛街") -> colorResourceId = R.drawable.ic_index_shopping
            indexName.contains("晾晒") -> colorResourceId = R.drawable.ic_index_sun_cure
            indexName.contains("洗车") -> colorResourceId = R.drawable.ic_index_car_wash
            indexName.contains("感冒") -> colorResourceId = R.drawable.ic_index_clod
            indexName.contains("广场舞") -> colorResourceId = R.drawable.ic_index_dance
        }
